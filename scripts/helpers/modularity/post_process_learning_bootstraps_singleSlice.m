function post_process_learning_bootstraps_singleSlice(path, file)
% function loads learning bootstrapping results from file and plots figure
load(fullfile(path, file));

%% get consensus modules across bootstraps
S_boot_conn_n = get_bootstrap_consensus(S_singl_n_boot, dropped_rows);
S_boot_conn_t = get_bootstrap_consensus(S_singl_t_boot, dropped_rows);
