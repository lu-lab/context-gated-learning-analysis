...
load('20251201_data_NaN_SNR_Duplicate_screened.mat', 'validData');
allData = validData;
...
writetable(RatioTable, '20251201_RatioFgFr_imprecise.csv');
save('20251201_RatioFgFr_fullPrecisionMatrix.mat', 'Ratio');

% load imprecise CSV
RatioTable = readtable('20251201_RatioFgFr_imprecise.csv');
load('20251201_RatioFgFr_fullPrecisionMatrix.mat', 'Ratio');
RatioTable{:, 9:end} = Ratio;
save('20251201_RatioFgFr_fullPrecisionTable.mat', 'RatioTable');

%% calculate dRRo
clear;
load('20251201_RatioFgFr_fullPrecisionTable.mat', 'RatioTable');
...
save('20251201_dRRo_101to150base.mat', 'dRRoTable');