...
%% Debug specific sheet readout if needed
relPath = "PA-buffer/acr-5p/Analysis/PA-Buffer";
fileName = "acr-5p image 20220704trained-worm5.xlsx";
sheetName = "URYD-002";
outTbl = read_excel_data(basePath, relPath, fileName, sheetName);
