...
nBootstrap = 2000;       % number of Monte Carlo iterations (30 - 100 for testing, 1-2k for statistics)
    ...
    for i_out = 1:numel(outputIDs)
        ...
        for t = 1:numel(trainingConditions)
            ...
            parfor b = 1:nBootstrap
                ...
                x = mean(X_sel(xIdx,:), 'omitnan')';
                y = mean(Y_sel(yIdx,:), 'omitnan')';
