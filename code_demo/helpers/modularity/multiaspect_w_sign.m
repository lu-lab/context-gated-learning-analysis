function [B, twom] = multiaspect_w_sign(A, gamma, omega, type)
...
%
% Adapted from multiaspect in GenLouvain toolbox, accounts for signs in
% adjacency matrices between network nodes
%
...
%     of earlier versions of our multilayer community detection codes.
    ...
    na = prod(aspects);
    [B, twom] = arrayfun(@(A, g) modularity_w_sign(A{1}, g), A, gamma, ...
                         'UniformOutput', false);
